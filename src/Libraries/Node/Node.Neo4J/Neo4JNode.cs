...
namespace NodeApi.Neo4J {
    ...
    [ScriptImport]
    [ScriptName("Node")]
    public sealed class Neo4JNode : Neo4JPropertyContainer {
        ...
        public void Save(Action<object, Neo4JNode> callback) {
        }
        ...
        public void Delete(Action<object, Neo4JNode> callback, bool force) {
        }
        ...
        public void CreateRelationshipTo(Neo4JNode otherNode, string type, Dictionary<string, object> data, Action<object, Neo4JRelationship> callback) {
        }
        ...
        /// <param name="callback">Returns a Relationship</param>
        /// <returns></returns>
        public void CreateRelationshipFrom(Neo4JNode otherNode, string type, Dictionary<string, object> data, Action<object, Neo4JRelationship> callback) {
        }
        ...
        /// <returns></returns>
        public void GetRelationships(List<string> types, Action<object, List<Neo4JRelationship>> callback) {
        }
        ...
        /// <param name="callback">Returns a list of Relationships</param>
        /// <returns></returns>
        public void Outgoing(List<string> types, Action<object, List<Neo4JRelationship>> callback) {
        }
        ...
        /// <param name="callback">Returns a list of Relationships</param>
        /// <returns></returns>
        public void Incoming(List<string> types, Action<object, List<Neo4JRelationship>> callback) {
        }
        ...
        /// <param name="callback">Returns a list of Relationships</param>
        public void All(List<string> types, Action<object, List<Neo4JRelationship>> callback) {
        }
        ...
        public void GetRelationshipNodes(List<String> rels, Action<object, List<Neo4JNode>> callback) {
        }
        ...
        public void Path(Neo4JNode to, string type, string direction, Int32 maxDepth, string algorithm, Action<object, Neo4JPath> callback) {
        }
    }
}
