...
namespace ScriptSharp.Parser {
    ...
    internal sealed class LexError {
        ...
        public static readonly Error UnexpectedEndOfFileStarSlash = new Error(110, 0, "Unexpected end of file found. '*/' expected.");
        public static readonly Error UnexpectedEndOfFileString = new Error(111, 0, "Unexpected end of file found. '\"' expected.");
    }
}
